        ...
        <div class="p-registerBooks__cards">
            ...
            <div class="p-registerBooks__card">
                ...
                <div class="p-registerBooks__upper">
                    <div id="js-showAllText" class="p-registerBooks__bookTitle">
                        ここにタイトルが入ります
                    </div>
                    <div :id="`js-toolTip`" class="p-registerBooks__toolTip">
                        ここにタイトルが入ります
                    </div>
                    <button
                        type="submit"
                ...
                <div class="p-registerBooks__lower">
                    <div class="p-registerBooks__bookImageWrap">
                        <img
                            class="p-registerBooks__bookImage"
                            src="http://books.google.com/books/content?id=Jb3GNmCzcIoC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
                            alt=""
                        />
                    </div>
                    <div class="p-registerBooks__bookInfoWrap">
                        <div class="p-registerBooks__authorWrap">
                            ...
                            <div class="p-registerBooks__authorName">
                                山田太郎あああああああああああああああああああああああああああああああああ
                            </div>
                        </div>
